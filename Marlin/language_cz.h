...
#define MSG_PREHEAT_3                       _UxGT("Zahrat PETG")
...
#define MSG_PREHEAT_4                       _UxGT("Zahrat TPE")
...
#define MSG_PREHEAT_5                       _UxGT("Zahrat ASA")
#define MSG_PREHEAT_5_N                     MSG_PREHEAT_5 _UxGT(" ")
#define MSG_PREHEAT_5_ALL                   MSG_PREHEAT_5 _UxGT(" vse")
#define MSG_PREHEAT_5_END                   MSG_PREHEAT_5 _UxGT(" hotend")
#define MSG_PREHEAT_5_BEDONLY               MSG_PREHEAT_5 _UxGT(" podloz")
#define MSG_PREHEAT_5_SETTINGS              MSG_PREHEAT_5 _UxGT(" nast")
#define MSG_PREHEAT_6                       _UxGT("Zahrat PVA")
#define MSG_PREHEAT_6_N                     MSG_PREHEAT_6 _UxGT(" ")
#define MSG_PREHEAT_6_ALL                   MSG_PREHEAT_6 _UxGT(" vse")
#define MSG_PREHEAT_6_END                   MSG_PREHEAT_6 _UxGT(" hotend")
#define MSG_PREHEAT_6_BEDONLY               MSG_PREHEAT_6 _UxGT(" podloz")
#define MSG_PREHEAT_6_SETTINGS              MSG_PREHEAT_6 _UxGT(" nast")
#define MSG_PREHEAT_7                       _UxGT("Zahrat PA")
#define MSG_PREHEAT_7_N                     MSG_PREHEAT_7 _UxGT(" ")
#define MSG_PREHEAT_7_ALL                   MSG_PREHEAT_7 _UxGT(" vse")
#define MSG_PREHEAT_7_END                   MSG_PREHEAT_7 _UxGT(" hotend")
#define MSG_PREHEAT_7_BEDONLY               MSG_PREHEAT_7 _UxGT(" podloz")
#define MSG_PREHEAT_7_SETTINGS              MSG_PREHEAT_7 _UxGT(" nast")
#define MSG_PREHEAT_8                       _UxGT("Zahrat HIPS")
#define MSG_PREHEAT_8_N                     MSG_PREHEAT_8 _UxGT(" ")
#define MSG_PREHEAT_8_ALL                   MSG_PREHEAT_8 _UxGT(" vse")
#define MSG_PREHEAT_8_END                   MSG_PREHEAT_8 _UxGT(" hotend")
#define MSG_PREHEAT_8_BEDONLY               MSG_PREHEAT_8 _UxGT(" podloz")
#define MSG_PREHEAT_8_SETTINGS              MSG_PREHEAT_8 _UxGT(" nast")
